...
module Fliclib
  module Protocol
    ...
    autoload :Commands, 'fliclib/protocol/commands'
    autoload :Events, 'fliclib/protocol/events'
    autoload :PacketHeader, 'fliclib/protocol/packet_header'
    autoload :Primitives, 'fliclib/protocol/primitives'
