...
module Flic
  class Client
    class ConnectionChannel
      ...
      attr_reader :button_bluetooth_address, :latency_mode, :auto_disconnect_time, :status
      ...
      def initialize(button_bluetooth_address, latency_mode, auto_disconnect_time)
